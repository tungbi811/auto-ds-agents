...
from multi_agents import (
    BusinessAnalyst, DataAnalyst, DataEngineer, DataScientist,
    BusinessTranslator, Coder
)
...
def run_workflow_background(data_paths, user_query, max_rounds, msg_queue):
    ...
    try:
        ...
        pattern = DefaultPattern(
            ...
            agents=[business_analyst, data_analyst, data_engineer, data_scientist, coder, business_translator],
            user_agent=user,
